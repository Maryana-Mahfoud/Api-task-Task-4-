...
const SignIn = () => {
  ...
  const handleLoginSubmit = async (formData: FormData) => {
    ...
    try {
      ...
      {/* handle success response by storing token and showing success pop-up, 
      ...
      if (response.ok) {
        ...
        {/*check if the response contains detailed error messages and display them, otherwise show a generic error message */}
        if (result.errors) {
